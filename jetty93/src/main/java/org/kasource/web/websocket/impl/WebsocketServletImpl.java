...
public class WebsocketServletImpl extends WebSocketServlet {
    ...
    public void configure(WebSocketServletFactory factory) {
        ...
        factory.getPolicy().setAsyncWriteTimeout(endpointConfig.getAsyncSendTimeoutMillis());
        factory.getPolicy().setMaxBinaryMessageBufferSize(endpointConfig.getMaxBinaryMessageBufferSizeByte());
        factory.getPolicy().setMaxTextMessageBufferSize(endpointConfig.getMaxTextMessageBufferSizeByte());
