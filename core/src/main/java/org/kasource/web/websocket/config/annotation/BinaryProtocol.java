...
/**
 * Add support for additional binary sub protocols that can be requested by the client.
 * 
 * @author rikardwi
 **/
...
public @interface BinaryProtocol {
    /**
     * Binary protocol name (for example a MIME type name), which can be requested by the client by setting
     * this as its sub protocol.
     **/
    String protocol();
     ...
     **/
    Class<? extends BinaryProtocolHandler> handler();
