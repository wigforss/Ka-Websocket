 ...
 * 
 * Note: The annotation @Websocket or @WebSocketListener can be used for the same purpose.
 * 
...
public interface WebSocketListenerRegistration {
    ...
    /**
     * Return the URL of the web socket to listen to.
     * 
     * @return URL of the web socket to listen to.
     **/
